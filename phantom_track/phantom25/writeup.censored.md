...
Non è disponibile alcuna nota per questo livello (`phantom_track/phantom25/notes.md` risulta senza contenuto registrato). Non è quindi possibile ricostruire con certezza l'obiettivo specifico assegnato dal brief del livello.
